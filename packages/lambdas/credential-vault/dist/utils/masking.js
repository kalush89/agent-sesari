...
exports.generateMaskedDisplay = generateMaskedDisplay;
/**
 ...
 */
function maskCredential(value, visibleChars = 4) {
 ...
 */
function generateMaskedDisplay(credentialType, data) {
