/**
 * Unit tests for HubSpot webhook signature verification
...
describe('webhook-security', () => {
  const mockSecret = 'test_webhook_secret_123';
  ...
  /**
   * Helper function to generate valid HubSpot signature
   */
  ...
  describe('getWebhookSecret', () => {
    it('should retrieve secret from environment variable', () => {
      process.env.HUBSPOT_WEBHOOK_SECRET = 'test_secret_123';
    ...
    it('should throw error if secret is not set', () => {
      ...
      expect(() => getWebhookSecret()).toThrow('HUBSPOT_WEBHOOK_SECRET environment variable is not set');
    });
