/**
 * CloudWatch metrics emission for HubSpot webhook processing observability
 ...
 */
const METRIC_NAMESPACE = 'RelationshipSenses/HubSpotConnector';

/**
 * Emits a metric for successful event processing
 * 
 * @param eventType - Type of relationship signal event processed
 */
