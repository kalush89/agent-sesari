/**
 * CloudWatch metrics emission for Mixpanel webhook processing observability
 ...
 */
const METRIC_NAMESPACE = 'BehavioralSenses/MixpanelConnector';

/**
 * Emits a metric for successful event processing
 * 
 * @param eventType - Type of behavioral signal event processed
 */
